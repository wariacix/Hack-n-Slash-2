...
private:
	...
	hns::TextObject goldIndicator = TextObject(920, 5, 20, 7, "goldBar", 30, sf::Color(255, 197, 0, 255), L"test", 10, -4, sf::Color::Black, 2.0f);
	hns::TextObject levelIndicator = TextObject(1450, 0, 27, 7, "levelBar", 27, sf::Color(83, 225, 0, 255), L"test", 25, 0, sf::Color::Black, 2.0f);
public:
